function handleGetPrivacy(req, res) {
  const policy = `
  <html><head></head><body><h1>Privacy Policy</h1>
  ...
  <ul>
      ...
      <li>
          <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to LaMetric Time toggl.com Integration.</p>
            </li>
        <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
      <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
    <li><strong>Website</strong> refers to LaMetric Time toggl.com Integration, accessible from https://lametric-time-toggl.herokuapp.com/api/v1</li>        <li><strong>Service</strong> refers to the Website.</li>
...
module.exports = { handleGetPrivacy };
